...
public class SimpleShadowShaderProgram extends ShaderProgram {


	public SimpleShadowShaderProgram(Context context, int vertexShaderRes, int fragmentShaderRes) {
